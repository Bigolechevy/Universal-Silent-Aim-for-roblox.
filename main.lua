...
--Its a 5 method silent aim by Averiias, revamped. Enjoy!
if not syn or not protectgui then
    getgenv().protectgui = function()end
end
local Library = loadstring(game:HttpGet('https://lindseyhost.com/UI/LinoriaLib.lua'))()
Library:SetWatermark("NIGGER CHEATS, FOR NIGGERS BY NIGGERS")
...
local Window = Library:CreateWindow("Universal Silent Aim FOR NIGGERS")
